...
public class CampComEnquiries extends Enquiry {

    // Constructor
    public CampComEnquiries() {
        super();
    }
    ...
    public void viewEnquiries() {
        ...
        {
            if(entry.getValue().getCampCommitteMembers().contains(Login.getuserObj())) //is the camp com member of the camp
            {
                ...
                break; //break when found camp they in charge of
            }
    ...
    public void replyEnquiry(int enqID)
    {
        ...
        for (Map.Entry<String, CampInfo> entry : CampDB.camps.entrySet()) 
        {
            ...
            for (Enquiry enquiry : campInfo.getEnquiry()) 
            {
                ...
                {
                    enquiryFound = true;
                    if(campInfo.getCampCommitteMembers().contains(Login.getuserObj())) //check if is the campcom of that enquiry
                    {
